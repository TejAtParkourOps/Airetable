...
export const errors = {
    "not-initialized": Error("The base is not initialized. Please call sync(...) function first.")  
} as const;
...
export class AireTableClient {
    ...
    async startSync(airtableBaseId: string) {
        ...
        this.#base = await this.#client.sendRequest<{authToken: string, baseId: string}, ABase>("sync-base-req", {
    ...
    get base() {
        if (this.#base)
            ...
            throw errors["not-initialized"];
    }
}


(async ()=>{
    const c = new AireTableClient("patvVIhW6YcAMw0cE.68a8a732bc788a931157e9e257bd72513628b94048e9572bc523ad12a91c50f0");
    try {
